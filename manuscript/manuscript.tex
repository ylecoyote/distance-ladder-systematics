...
\begin{equation}
\sigma_{\rm sys,corr}^2 = \underbrace{2.11~({\rm km~s^{-1}~Mpc^{-1}})^2}_{\text{diagonal: } \sum_i \sigma_i^2} + \underbrace{0.81~({\rm km~s^{-1}~Mpc^{-1}})^2}_{\text{off-diagonal: } 2\sum_{i<j} \sigma_i \sigma_j \rho_{ij}} = 2.92~({\rm km~s^{-1}~Mpc^{-1}})^2
\end{equation}
