...
\enddata
\tablenotetext{}{TRGB distance moduli from CCHP \textit{JWST} NIRCam observations \citep{Freedman2024}. Cepheid distance moduli from SH0ES HST observations \citep{Riess2022}. Offset $\Delta\mu = \mu_{\rm Cepheid} - \mu_{\rm TRGB}$. Weighted mean offset: $\langle\Delta\mu\rangle = -0.024 \pm 0.020$ mag. RMS scatter: 0.108 mag (factor 2.3$\times$ larger than JAGB-TRGB scatter of 0.048 mag), providing empirical evidence for enhanced Cepheid systematic uncertainties.}
\end{deluxetable*}
