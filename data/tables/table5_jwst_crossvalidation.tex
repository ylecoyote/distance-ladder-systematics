...
\enddata
\tablenotetext{}{TRGB distance moduli are from CCHP \textit{JWST} NIRCam observations \citep{Freedman2025a}; Cepheid distance moduli are from SH0ES \citep{Riess2022}. The weighted mean offset is $\langle\Delta\mu\rangle = -0.023 \pm 0.020$ mag, with RMS scatter 0.107 mag. Offset $\Delta\mu = \mu_{\rm Cepheid} - \mu_{\rm TRGB}$.}
\end{deluxetable*}
