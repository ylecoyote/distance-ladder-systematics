...
\textbf{(4) Minor correlations}: photometry-extinction (7$\leftrightarrow$6$\leftrightarrow$8, $\rho = 0.2$).
...
Machine-readable version: \texttt{data/correlation\_matrix.csv}
}
