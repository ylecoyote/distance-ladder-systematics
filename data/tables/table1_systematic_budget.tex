% Table 1: Systematic Error Budget for Cepheid-based H₀ Measurements
% Generated from systematic error budget analysis
% Scenario A + Prior 1 baseline (9 independent systematic sources)
